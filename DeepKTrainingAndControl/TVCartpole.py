...
class CartPoleEnv(gym.Env):
    ...
    def __init__(self):
        ...
        self.mup = 0.000002 # coefficient of friction of pole on cart
        self.gravity = 9.8
        self.masscart = 1.0
        self.masspole = 0.1
    ...
    def step(self, input):
        ...
        temp = (
            force + self.polemass_length * theta_dot ** 2 * sintheta - self.muc * np.sign(x_dot)
        ) / self.total_mass
        thetaacc = (self.gravity * sintheta - costheta * temp - (self.mup * theta_dot / self.polemass_length)) / (
